...
class RoutingSolutionJsonTests(unittest.TestCase):
    def test_bird_solution_json_uses_school_local_stop_ids(self) -> None:
        ...
        self.assertEqual(report.solution[0].student_ids, ["student-near-a"])
        ...
        self.assertEqual(report.solution[1].student_ids, ["student-near-b"])
    ...
    def test_fleet_aware_bird_solution_json_uses_original_bus_and_depot(self) -> None:
        ...
        self.assertEqual(report.solution[0].stop_node_ids, [101])
        self.assertEqual(report.solution[0].student_ids, ["bird-student-a"])
